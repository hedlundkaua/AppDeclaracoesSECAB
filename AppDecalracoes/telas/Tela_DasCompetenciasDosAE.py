...
def abrir_tela():
    def gerar_documento():
        try:
            ...
            #caminho do modelo
            modelo_path = caminho_arquivo("W:\DRH\SECAB\Kaua Teste\modelos\declaracao_DasCompetenciasDosAE.docx")
            ...
            nome_arquivo = f"{nome.replace(' ','_')}_declaracao_DasCompetenciasDosAE {data_hoje}.docx"
    ...
    janela = tk.Tk()
    janela.title("Declaração das competencas dos AEs")
