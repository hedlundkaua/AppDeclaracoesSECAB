...
def abrir_tela():
    ...
    def gerar_documento():
        try:
            ...
            #caminho do modelo
            modelo_path = caminho_arquivo("W:\DRH\SECAB\Kaua Teste\modelos\declaracao_vinculo.docx")
            ...
            nome_arquivo = f"{nome.replace(' ','_')}_declaracao_negativaPADServidorAtivo {data_hoje}.docx"
    ...
    janela = tk.Tk()
    janela.title("Declaração de Negativa PAD (Servidor Ativo)")
