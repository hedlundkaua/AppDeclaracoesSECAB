...
def abrir_tela():
    def gerar_documento():
        try:
            ...
            #caminho do modelo
            modelo_path = caminho_arquivo("W:\DRH\SECAB\Kaua Teste\modelos\declaracao_DasCompetenciasDosAFRE.docx")
            ...
            nome_arquivo = f"{nome.replace(' ','_')}_declaracao_DasCompetenciasDosAFRE {data_hoje}.docx"
    ...
    janela = tk.Tk()
    janela.title("Declaração das competencas dos AFREs")
    ...
    tk.Label(janela, text="Pagina:").grid(row=5, column=0, sticky="e")
